        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                ...
                <li class="nav-item menu-items">
                    <a class="nav-link" href="../forms/add_etudiant.php">
                ...
                <i class="mdi mdi-speedometer"></i>
                        ...
                        <span class="menu-title">Filière et Niveau</span>
                    </a>
                </li>
                <li class="nav-item menu-items">
                            ...
                            <div class="card">
                                <div class="card-body">
                                  ...
                                  <input type="checkbox" class="form-check-input">
                                                    ...
                                                    <td> 04 Dec 2019 </td>
                                                    <td>
                                                        <div class="badge badge-outline-success">valider</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                  ...
                                  <input type="checkbox" class="form-check-input">
                                                    ...
                                                    <td> 04 Dec 2019 </td>
                                                    <td>
                                                        <div class="badge badge-outline-warning">En cour</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                  ...
                                  <input type="checkbox" class="form-check-input">
                                                    ...
                                                    <td> 04 Dec 2019 </td>
                                                    <td>
                                                        <div class="badge badge-outline-danger">Rejecter</div>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
