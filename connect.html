          ...
          <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active">
                <a class="nav-link" href="">Espace Administration</a>
              </li>
...
<fieldset id="entete">
    <center> 
        ...
        <button class="button" type="submit" name="envoyer"><a href="home.php" style="color:white;">Exécuter  </a></button>
  ...
  <div class="modal fade" id="card0" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true"  >
                        <div class="modal-dialog" >
                            <div class="modal-content">
                            <div class="modal-header">
                                <h5" class="modal-title" id="exampleModalLabel">Bienvenue à l'Université international de Cote d'Ivoire (UICI )</h5>
