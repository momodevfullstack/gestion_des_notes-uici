...
<div class="row clearfix" style="padding: 150px;">
                        ...
                        <div class="body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-striped table-hover js-basic-example dataTable">
                                    <thead >
                                        <tr >
                                            <th style="font-size: 30px; font-size:bold; color:white;background:orangered;">Matricul</th>
                                            <th style="font-size: 30px; font-size:bold; color:white;background:orangered;">Nom</th>
                                            <th style="font-size: 30px; font-size:bold; color:white;background:orangered;">Prenom</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td style="font-size: 20px; font-size:bold; color:white; ">Sonya Frost</td>
                                            <td style="font-size: 20px; font-size:bold; color:white;">Software Engineer</td>
                                            <td style="font-size: 20px; font-size:bold; color:white;">Edinburgh</td>
