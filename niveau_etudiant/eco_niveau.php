            ...
            <div class="main-panel" style=" background-color:white;" >
                ...
                <button class="bt "  style="  box-shadow: 0 0 40px #000000;width: 150px; height:50px;font-weight: bold; color: black;border:none;margin-left:-185px; background-color:orangered;" id="cart" name="add_to_cart"><i class="fa fa-cart-plus" aria-hidden="true"></i>retour</button>
                    ...
                    <div class="row" >
                        ...
                        <div class="div-image">
                        <img  class="img" src="../../admin/assets/images/eco-l1.jpg" alt="">
                        </div>
                        ...
                        <div class="col-6" style="width:150px ;">
                       <div >
                        <img class="img"  src="../../admin/assets/images/ecco-l2.jpg" alt="">
                        </div>
                       ...
                       <div >
                        <img class="img"  src="../../admin/assets/images/eco-l3.jpg" alt="">
                        </div>
                        <button class="btn "  style="color: black;border:2px solid black;" id="cart" name="add_to_cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Voir la liste</button>
                        </div>
                        ...
                        <div class="col-6" style="top:70px ;width: 150px;">
                       <div >
                        <img class="img"  src="../../admin/assets/images/eco-master1.jpg" alt="">
                        </div>
                        <button class="btn "  style="color: black;border:2px solid black;" id="cart" name="add_to_cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Voir la liste</button>
                        </div>
                       ...
                       <div >
                        <img class="img"  src="../../admin/assets/images/eco-master2.jpg" alt="">
                        </div>
                        <button class="btn "  style="color: black;border:2px solid black;" id="cart" name="add_to_cart"><i class="fa fa-cart-plus" aria-hidden="true"></i> Voir la liste  ISN Master 2</button>
                        </div>
